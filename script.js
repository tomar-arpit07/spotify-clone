...
async function getSongs(folder) {
    currFolder = folder;
    let a = await fetch(`https://github.com/tomar-arpit07/spotify-clone/tree/main/${folder}/`);
...
async function displayAlbums() {
    ...
    let a = await fetch(`https://github.com/tomar-arpit07/spotify-clone/tree/main/songs/`);
    let response = await a.text();
    let div = document.createElement("div");
    div.innerHTML = response;
    ...
    for (let index = 0; index < array.length; index++) {
        ...
        if (e.href.includes("/songs") && !e.href.includes(".htaccess")){
            ...
            let a = await fetch(`https://github.com/tomar-arpit07/spotify-clone/tree/main/songs/${folder}/info.json`);
